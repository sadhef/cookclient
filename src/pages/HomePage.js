...
import { FaMicrophone, FaCalculator, FaLanguage, FaHeart, FaStar, FaUtensils, FaClock, FaSearch } from 'react-icons/fa';
      ...
      <div className="relative text-white overflow-hidden rounded-b-[50px] shadow-xl">
        ...
        <div className="container mx-auto px-4 relative z-10 pt-20 pb-28">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Search Button - Only functional for logged-in users */}
            <div className="mb-8 transform hover:scale-102 transition-transform duration-300">
              {isAuthenticated ? (
                <Link to="/search" className="py-4 px-8 bg-gradient-to-r from-pink-400 to-rose-500 text-white font-medium rounded-full hover:from-pink-500 hover:to-rose-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-400 shadow-md transition-all duration-300 inline-flex items-center space-x-2">
                  <FaSearch />
                ...
                <button 
                  ...
                  className="py-4 px-8 bg-gradient-to-r from-pink-400 to-rose-500 text-white font-medium rounded-full hover:from-pink-500 hover:to-rose-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-400 shadow-md transition-all duration-300 inline-flex items-center space-x-2"
                >
                  <FaSearch />
                  <span>{t('search_recipes')}</span>
                </button>
